...
namespace ExtremeInsiders.Migrations
{
    ...
    [Migration("20210821174007_AddedNewModels")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExtremeInsiders.Entities.FcmToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ExtremeInsiders.Entities.UserNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ExtremeInsiders.Entities.Sport", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2021, 8, 21, 17, 40, 6, 986, DateTimeKind.Utc).AddTicks(7702)
                        });
                });
            ...
            modelBuilder.Entity("ExtremeInsiders.Entities.Playlist", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2,
                            DateCreated = new DateTime(2021, 8, 21, 17, 40, 6, 986, DateTimeKind.Utc).AddTicks(8266),
                            SportId = 1
                        });
                });
            ...
            modelBuilder.Entity("ExtremeInsiders.Entities.Movie", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 4,
                            DateCreated = new DateTime(2021, 8, 21, 17, 40, 6, 986, DateTimeKind.Utc).AddTicks(8996),
                            SportId = 1
                        });
                });
            ...
            modelBuilder.Entity("ExtremeInsiders.Entities.Video", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            DateCreated = new DateTime(2021, 8, 21, 17, 40, 6, 986, DateTimeKind.Utc).AddTicks(8773),
                            PlaylistId = 2
                        });
                });
