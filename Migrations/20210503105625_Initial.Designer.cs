...
namespace ExtremeInsiders.Migrations
{
    ...
    [Migration("20210503105625_Initial")]
            ...
            modelBuilder.Entity("ExtremeInsiders.Entities.Sport", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2021, 5, 3, 10, 56, 24, 847, DateTimeKind.Utc).AddTicks(9428)
                        });
                });
            ...
            modelBuilder.Entity("ExtremeInsiders.Entities.Playlist", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2,
                            DateCreated = new DateTime(2021, 5, 3, 10, 56, 24, 848, DateTimeKind.Utc).AddTicks(27),
                            SportId = 1
                        });
                });
            ...
            modelBuilder.Entity("ExtremeInsiders.Entities.Movie", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 4,
                            DateCreated = new DateTime(2021, 5, 3, 10, 56, 24, 848, DateTimeKind.Utc).AddTicks(758),
                            SportId = 1
                        });
                });
            ...
            modelBuilder.Entity("ExtremeInsiders.Entities.Video", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            DateCreated = new DateTime(2021, 5, 3, 10, 56, 24, 848, DateTimeKind.Utc).AddTicks(517),
                            PlaylistId = 2
                        });
                });
