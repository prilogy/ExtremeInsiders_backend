...
namespace ExtremeInsiders.Migrations
{
    ...
    [Migration("20210505184441_ChangedPaymentInfrastructure")]
    partial class ChangedPaymentInfrastructure
    {
            ...
            modelBuilder.Entity("ExtremeInsiders.Entities.Sport", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2021, 5, 5, 18, 44, 40, 810, DateTimeKind.Utc).AddTicks(9217)
                        });
                });
            ...
            modelBuilder.Entity("ExtremeInsiders.Entities.Playlist", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2,
                            DateCreated = new DateTime(2021, 5, 5, 18, 44, 40, 810, DateTimeKind.Utc).AddTicks(9764),
                            SportId = 1
                        });
                });
            ...
            modelBuilder.Entity("ExtremeInsiders.Entities.Movie", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 4,
                            DateCreated = new DateTime(2021, 5, 5, 18, 44, 40, 811, DateTimeKind.Utc).AddTicks(485),
                            SportId = 1
                        });
                });
            ...
            modelBuilder.Entity("ExtremeInsiders.Entities.Video", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            DateCreated = new DateTime(2021, 5, 5, 18, 44, 40, 811, DateTimeKind.Utc).AddTicks(248),
                            PlaylistId = 2
                        });
                });
