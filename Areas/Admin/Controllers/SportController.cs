...
namespace ExtremeInsiders.Areas.Admin.Controllers
{
    ...
    public class SportController : Controller
    {
        ...
        {
            var applicationContext = _context.Sports.Include(s => s.Image);
        ...
        public async Task<IActionResult> Create([Bind("Id,ImageId")] Sport sport)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ImageId")] Sport sport)
        {
            if (id != sport.Id)
            {
                return NotFound();
